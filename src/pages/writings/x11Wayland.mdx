...
2. Add standardized D-Bus interfaces for communicating with compositors. This is to my understanding what mutter currently does to allow for the special Orca modifier [here](https://gitlab.gnome.org/GNOME/mutter/-/blob/main/data/dbus-interfaces/org.freedesktop.a11y.xml?ref_type=heads). 
