...
const portfolioItems: PortfolioItem[] = [
  {
    ...
    description: 'Synchronize the contents of a S3 bucket with a graph database',
  ...
  },
  {
    ...
    description: 'Typescript rewrite of the frontend for the World Meterological Foundation\'s distributed weather system',
    category: 'Frontend',
    language: 'Typescript',
  },
  {
    ...
    description: 'Generate AI audiobooks from any text format; contains a custom epub parser',
  ...
  },
  {
    ...
    description: 'Integrate the Talon voice dictation software with a screen reader for use by blind individuals',
    category: 'Accessibility',
  ...
  },
  {
    ...
    description: 'Integrate the Talon voice dictation software with large language models for more accessible and intelligent voice control',
    category: 'Accessibility',
  ...
  },
  {
    ...
    description: 'A data orchestrator for the Geoconnex project',
    category: 'Data Engineering',
    language: 'Python',
  }
];
...
export default function PortfolioTable() {
  const [sortField, setSortField] = useState<'title' | 'language' | 'category' | null>(null);
        ...
        <table className="min-w-full table-auto border border-gray-200 dark:border-gray-700 text-left">
          ...
          <tbody>
            {sortedItems.map(item => (
              <tr
                key={item.id}
                className="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-neutral-700"
              >
